...
document.write("&nbsp;<font class=data align=right>"+dz+"-"+m+"-"+rok+"&nbsp;</font>");
}

function spacja(nr) {for (i=1; i<=nr; i++) document.write('&nbsp;')}

function pasekoe(oknr) { 
document.getElementById('opcja'+oknr).style.background='#aa0000'; document.getElementById('opcja'+oknr).style.color='#ffff00';
}

function pasekon(oknr) { 
document.getElementById('opcja'+oknr).style.background='#000094'; document.getElementById('opcja'+oknr).style.color='#ffff00';
}

function pasekofe(oknr) { 
document.getElementById('opcja'+oknr).style.background='#ff0000'; document.getElementById('opcja'+oknr).style.color='#ddffdd';
}

function pasekoff(oknr) { 
document.getElementById('opcja'+oknr).style.background='#5555aa'; document.getElementById('opcja'+oknr).style.color='#ddffdd';
}
